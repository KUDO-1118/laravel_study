                                    ...
                                    <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="1" {{ old('age') == 0 ? 'selected' : '' }}>～19歳</option>
                                                    <option value="2" {{ old('age') == 1 ? 'selected' : '' }}>20歳～29歳</option>
                                                    <option value="3"{{ old('age') == 2 ? 'selected' : '' }}>30歳～39歳</option>
                                                    <option value="4"{{ old('age') == 3 ? 'selected' : '' }}>40歳～49歳</option>
                                                    <option value="5"{{ old('age') == 4 ? 'selected' : '' }}>50歳～59歳</option>
                                                    <option value="6"{{ old('age') == 5 ? 'selected' : '' }}>60歳～</option>
                                                </select>
                                            </div>
                                            </div>
